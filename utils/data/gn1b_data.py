...
graspnet_root = "/media/pollen/T7/graspnet"
...
class GraspNet1BDataset(GraspDatasetBase):
    ...
    def get_depth(self, idx, rot=0, zoom=1.0):
        ...
        depth_img = image.DepthImage.from_tiff(self.g_depth_files[idx])
        #depth_img = image.DepthImage.from_tiff(self.g_depth_files[idx], 1000.0)
