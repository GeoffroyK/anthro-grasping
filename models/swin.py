...
def trunc_normal_(tensor, mean=0.0, std=1.0, a=-2.0, b=2.0):
    ...
    the bounds. The method used for generating the randomzer values works
...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        self, img_size=300, patch_size=4, in_chans=1, embed_dim=96, norm_layer=None
    ):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = SwinTransformerSys(
        in_chans=1, embed_dim=24, num_heads=[3, 6, 12, 24]
    ).cuda()
